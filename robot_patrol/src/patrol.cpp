...
private:
  ...
  void scanCallback(const sensor_msgs::msg::LaserScan::SharedPtr msg) {
    ...
    // Get min distance value at front side (45 degree to 135 degree). get
    // direction.
    ...
    // Get max distance value at front side (0 degree to 180 degree). get
    // direction.
  ...
  void timerCallback() {
    ...
    if (front_ > 0.35) {
      ...
      checkvicinity(cmd);
      RCLCPP_INFO(this->get_logger(),
                  "I am turning to longest distance direction");
    }
